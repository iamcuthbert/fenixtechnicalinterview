...
def get_days_of_power():
    r1 = int(input('Enter the daily rate 1: '))
    d1 = int(input('Enter the days when daily rate 1 starts: '))
    r2 = int(input('Enter the daily rate 2: '))
    d2 = int(input('Enter the days when daily rate 2 starts: '))
    r3 = int(input('Enter the daily rate 3: '))
    d3 = int(input('Enter the days when daily rate 3 starts: '))
    k = int(input('Enter the your payment amount: '))
